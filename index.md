...
<section class="services">
    ...
    <div class="service">
        <h3>Integrations</h3>
        <p>Connect your systems and automate the flow of data between them.</p>
    ...
    <div class="service">
        ...
        <p>Get technical planning, architecture guidance, and delivery oversight from planning through implementation.</p>
